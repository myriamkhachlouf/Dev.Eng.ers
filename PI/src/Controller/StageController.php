...
class StageController extends Controller
{
     ...
     * @return Response
     */
    public function index(StageRepository $stageRepository,OffreRepository $offreRepository, Request $request,EntrepriseRepository $EnreRepository): Response
     ...
     * @return Response
     */
    public function tri (StageRepository $stageRepository,OffreRepository $offreRepository, Request $request,EntrepriseRepository $EnreRepository): Response
    {
        $entreprise = $EnreRepository->findAll();
        $offre = $offreRepository->findAll();
